...
#:
#: Call as ``empa_score(y_true, y_score, alpha=12, beta=1/0.0015, contact_cost=50,
#: sales_cost=500, direct_selling=1, commission=0.1)``.
#:
#: .. note::
...
#:     before.
#:
#: Use :meth:`~empulse.metrics.Metric.optimal_rate` on this metric to get the fraction of leads
#: that should be targeted to maximize profit, and :func:`~empulse.metrics.mpa_score` for a
#: deterministic version of this metric.
#:
#: Examples
#: --------
#: .. code-block:: python
