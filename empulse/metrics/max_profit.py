...
#: Call as ``max_profit_score(y_true, y_score, tp_cost=..., tn_cost=..., fp_cost=..., fn_cost=...)``.
#: Use :meth:`~empulse.metrics.Metric.optimal_rate` on this metric to get the predicted positive
#: rate at which the maximum profit is achieved, and
