...
def _validate_input(y_true: ArrayLike, y_pred: ArrayLike, roi: float) -> tuple[np.ndarray, np.ndarray]:
...
def _validate_input_mp(
    y_true: ArrayLike, y_pred: ArrayLike, default_prob: float, roi: float
...
def _validate_input_emp(
    y_true: ArrayLike, y_pred: ArrayLike, p_0: float, p_1: float, roi: float
) -> tuple[np.ndarray, np.ndarray]:
